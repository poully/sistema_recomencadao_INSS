...
const Schema: z.ZodType<Prisma.BeneficioUpdateManyWithoutSituacaoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficioUpdateManyWithoutSituacaoNestedInputObjectSchema = Schema;
