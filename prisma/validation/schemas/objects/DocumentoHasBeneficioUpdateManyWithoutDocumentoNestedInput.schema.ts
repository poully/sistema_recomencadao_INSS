...
const Schema: z.ZodType<Prisma.DocumentoHasBeneficioUpdateManyWithoutDocumentoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DocumentoHasBeneficioUpdateManyWithoutDocumentoNestedInputObjectSchema =
  Schema;
