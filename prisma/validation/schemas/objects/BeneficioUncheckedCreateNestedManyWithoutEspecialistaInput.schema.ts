...
const Schema: z.ZodType<Prisma.BeneficioUncheckedCreateNestedManyWithoutEspecialistaInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficioUncheckedCreateNestedManyWithoutEspecialistaInputObjectSchema =
  Schema;
