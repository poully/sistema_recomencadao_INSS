...
const Schema: z.ZodType<Prisma.BeneficioUpdateManyWithWhereWithoutEspecialistaInput> =
  z
    .object({
...
export const BeneficioUpdateManyWithWhereWithoutEspecialistaInputObjectSchema =
  Schema;
