...
const Schema: z.ZodType<Prisma.MovimentacaoUncheckedUpdateManyWithoutTipo_movimentacaoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MovimentacaoUncheckedUpdateManyWithoutTipo_movimentacaoNestedInputObjectSchema =
  Schema;
