...
const Schema: z.ZodType<Prisma.AuxilioMaternidadeUncheckedCreateNestedManyWithoutBeneficioInput> =
  z
    .object({
      create: z
        .union([
...
export const AuxilioMaternidadeUncheckedCreateNestedManyWithoutBeneficioInputObjectSchema =
  Schema;
