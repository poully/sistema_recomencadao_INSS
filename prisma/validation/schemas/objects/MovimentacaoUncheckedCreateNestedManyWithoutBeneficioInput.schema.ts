...
const Schema: z.ZodType<Prisma.MovimentacaoUncheckedCreateNestedManyWithoutBeneficioInput> =
  z
    .object({
      create: z
        .union([
...
export const MovimentacaoUncheckedCreateNestedManyWithoutBeneficioInputObjectSchema =
  Schema;
