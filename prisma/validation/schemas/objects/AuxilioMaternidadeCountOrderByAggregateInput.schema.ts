...
const Schema: z.ZodType<Prisma.AuxilioMaternidadeCountOrderByAggregateInput> = z
  .object({
...
export const AuxilioMaternidadeCountOrderByAggregateInputObjectSchema = Schema;
