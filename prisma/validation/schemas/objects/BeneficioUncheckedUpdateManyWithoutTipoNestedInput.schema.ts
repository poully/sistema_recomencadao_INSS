...
const Schema: z.ZodType<Prisma.BeneficioUncheckedUpdateManyWithoutTipoNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => BeneficioUpdateManyWithWhereWithoutTipoInputObjectSchema,
          ),
          z
            .lazy(
              () => BeneficioUpdateManyWithWhereWithoutTipoInputObjectSchema,
...
export const BeneficioUncheckedUpdateManyWithoutTipoNestedInputObjectSchema =
  Schema;
