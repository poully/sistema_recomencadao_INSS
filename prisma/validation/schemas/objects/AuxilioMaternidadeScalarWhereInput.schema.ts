...
const Schema: z.ZodType<Prisma.AuxilioMaternidadeScalarWhereInput> = z
  .object({
    AND: z
      .union([
      ...
      .optional(),
    OR: z
      .lazy(() => AuxilioMaternidadeScalarWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const AuxilioMaternidadeScalarWhereInputObjectSchema = Schema;
