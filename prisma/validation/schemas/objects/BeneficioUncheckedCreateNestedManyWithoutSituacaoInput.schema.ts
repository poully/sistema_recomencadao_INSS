...
const Schema: z.ZodType<Prisma.BeneficioUncheckedCreateNestedManyWithoutSituacaoInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficioUncheckedCreateNestedManyWithoutSituacaoInputObjectSchema =
  Schema;
