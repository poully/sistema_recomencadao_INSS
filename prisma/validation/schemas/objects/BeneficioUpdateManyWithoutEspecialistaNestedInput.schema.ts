...
const Schema: z.ZodType<Prisma.BeneficioUpdateManyWithoutEspecialistaNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficioUpdateManyWithoutEspecialistaNestedInputObjectSchema =
  Schema;
