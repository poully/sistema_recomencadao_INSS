...
const Schema: z.ZodType<Prisma.MovimentacaoUncheckedCreateNestedManyWithoutTipo_movimentacaoInput> =
  z
    .object({
      create: z
        .union([
...
export const MovimentacaoUncheckedCreateNestedManyWithoutTipo_movimentacaoInputObjectSchema =
  Schema;
