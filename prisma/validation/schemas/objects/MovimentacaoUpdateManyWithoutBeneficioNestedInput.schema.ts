...
const Schema: z.ZodType<Prisma.MovimentacaoUpdateManyWithoutBeneficioNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MovimentacaoUpdateManyWithoutBeneficioNestedInputObjectSchema =
  Schema;
