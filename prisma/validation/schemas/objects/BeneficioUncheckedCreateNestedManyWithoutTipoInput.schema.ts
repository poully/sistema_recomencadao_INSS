...
const Schema: z.ZodType<Prisma.BeneficioUncheckedCreateNestedManyWithoutTipoInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficioUncheckedCreateNestedManyWithoutTipoInputObjectSchema =
  Schema;
