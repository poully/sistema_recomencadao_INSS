...
const Schema: z.ZodType<Prisma.DocumentoHasBeneficioCreateNestedManyWithoutBeneficioInput> =
  z
    .object({
      create: z
        .union([
...
export const DocumentoHasBeneficioCreateNestedManyWithoutBeneficioInputObjectSchema =
  Schema;
