...
const Schema: z.ZodType<Prisma.CidadeUpdateManyWithoutEstadoNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => CidadeUpsertWithWhereUniqueWithoutEstadoInputObjectSchema),
        z
          .lazy(() => CidadeUpsertWithWhereUniqueWithoutEstadoInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => CidadeUpdateWithWhereUniqueWithoutEstadoInputObjectSchema),
        z
          .lazy(() => CidadeUpdateWithWhereUniqueWithoutEstadoInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const CidadeUpdateManyWithoutEstadoNestedInputObjectSchema = Schema;
