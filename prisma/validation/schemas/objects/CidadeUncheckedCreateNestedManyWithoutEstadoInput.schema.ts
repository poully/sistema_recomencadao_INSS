...
const Schema: z.ZodType<Prisma.CidadeUncheckedCreateNestedManyWithoutEstadoInput> =
  z
    .object({
      create: z
        .union([
...
export const CidadeUncheckedCreateNestedManyWithoutEstadoInputObjectSchema =
  Schema;
