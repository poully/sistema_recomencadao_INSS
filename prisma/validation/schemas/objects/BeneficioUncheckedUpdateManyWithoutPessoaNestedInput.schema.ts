...
const Schema: z.ZodType<Prisma.BeneficioUncheckedUpdateManyWithoutPessoaNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficioUncheckedUpdateManyWithoutPessoaNestedInputObjectSchema =
  Schema;
