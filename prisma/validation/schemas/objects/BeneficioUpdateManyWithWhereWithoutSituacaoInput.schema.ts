...
const Schema: z.ZodType<Prisma.BeneficioUpdateManyWithWhereWithoutSituacaoInput> =
  z
    .object({
...
export const BeneficioUpdateManyWithWhereWithoutSituacaoInputObjectSchema =
  Schema;
