...
const Schema: z.ZodType<Prisma.BeneficioUncheckedCreateNestedManyWithoutPessoaInput> =
  z
    .object({
      create: z
        .union([
...
export const BeneficioUncheckedCreateNestedManyWithoutPessoaInputObjectSchema =
  Schema;
