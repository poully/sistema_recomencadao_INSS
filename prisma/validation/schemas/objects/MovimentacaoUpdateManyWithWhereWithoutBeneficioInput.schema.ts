...
const Schema: z.ZodType<Prisma.MovimentacaoUpdateManyWithWhereWithoutBeneficioInput> =
  z
    .object({
...
export const MovimentacaoUpdateManyWithWhereWithoutBeneficioInputObjectSchema =
  Schema;
