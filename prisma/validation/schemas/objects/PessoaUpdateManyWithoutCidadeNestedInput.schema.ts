...
const Schema: z.ZodType<Prisma.PessoaUpdateManyWithoutCidadeNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => PessoaUpsertWithWhereUniqueWithoutCidadeInputObjectSchema),
        z
          .lazy(() => PessoaUpsertWithWhereUniqueWithoutCidadeInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => PessoaUpdateWithWhereUniqueWithoutCidadeInputObjectSchema),
        z
          .lazy(() => PessoaUpdateWithWhereUniqueWithoutCidadeInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const PessoaUpdateManyWithoutCidadeNestedInputObjectSchema = Schema;
