...
const Schema: z.ZodType<Prisma.BeneficioUpdateManyWithWhereWithoutTipoInput> = z
  .object({
...
export const BeneficioUpdateManyWithWhereWithoutTipoInputObjectSchema = Schema;
