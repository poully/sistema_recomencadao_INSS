...
const Schema: z.ZodType<Prisma.DocumentoHasBeneficioUncheckedCreateNestedManyWithoutDocumentoInput> =
  z
    .object({
      create: z
        .union([
...
export const DocumentoHasBeneficioUncheckedCreateNestedManyWithoutDocumentoInputObjectSchema =
  Schema;
