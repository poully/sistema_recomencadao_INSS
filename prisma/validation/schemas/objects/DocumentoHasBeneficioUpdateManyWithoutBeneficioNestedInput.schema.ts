...
const Schema: z.ZodType<Prisma.DocumentoHasBeneficioUpdateManyWithoutBeneficioNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DocumentoHasBeneficioUpdateManyWithoutBeneficioNestedInputObjectSchema =
  Schema;
