...
const Schema: z.ZodType<Prisma.AuxilioMaternidadeUpdateManyWithoutBeneficioNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const AuxilioMaternidadeUpdateManyWithoutBeneficioNestedInputObjectSchema =
  Schema;
