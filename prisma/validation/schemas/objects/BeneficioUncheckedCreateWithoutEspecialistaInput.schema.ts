...
const Schema: z.ZodType<Prisma.BeneficioUncheckedCreateWithoutEspecialistaInput> =
  z
    .object({
...
export const BeneficioUncheckedCreateWithoutEspecialistaInputObjectSchema =
  Schema;
